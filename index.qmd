---
title: "Statistical Methods - Spring 2025"
execute: 
  freeze: false
---
...
library(tidyverse)
gs4_deauth()
d <- read_sheet("https://docs.google.com/spreadsheets/d/1_FBrQxZGL4vgLjAlAlXueWs1wp6HnYs-bu-nSkH6lQQ/edit?usp=sharing")
```

```{r}
#| echo: false

d[d$date < max(today()+21, as.Date("2025-02-04")),] |>
